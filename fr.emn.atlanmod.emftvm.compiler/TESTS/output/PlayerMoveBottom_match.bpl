...
implementation PlayerMoveBottom_match(s: ref,rec: ref,pac: ref,grid2: ref,grid1: ref,act: ref,ghost: ref) returns (r: bool)
{
...
call stk := OpCode#PUSHF(stk);
label_48:
label_END_rule_PlayerMoveBottom_matcher:
r:=$Unbox(top(stk));
